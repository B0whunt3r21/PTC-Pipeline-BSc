...
In there, place the corresponding **.fit** files with the naming as follows:
...
To run the code, open the project in the terminal, and run the main.py.
...
### Future?:
Future plans might include to generalize the code further, to support more formats, such as general RAW images.
Optionally the option to make a Dark-PTC to retrieve the DSNU, might be implemented.
